#!/usr/bin/env python
"""300 epochs, eval every 25 — same as run_300ep_eval25 but:
  • lag_exclude_types=("e",)   → drop T_e from I_lag,nbr
  • lag_order=3                → 3 self-lags instead of 10
"""
...
SAVE_DIR = pathlib.Path("output_plots/stage2/run_300ep_dropTe_lag3")
...
def main():
    ...
    print(f"=== 300ep  |  drop-Te  |  lag_order=3  |  eval@25 ===")
